        ...
        <div className={`flex w-full`}>
          ...
          <div className={`w-[75%] block relative`}>
            ...
            <div className={`flex bottom-0 left-0`}>
              <div>
                <div className={`right-0 bottom-0 flex absolute`}>
                  <button
                    type="button"
                    className={`h-[3rem] w-[12rem] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-md px-5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`}
